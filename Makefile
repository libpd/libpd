...
$(LIBPDS): libpds/m_libpd_autogenerated.h libpds/m_libpd.h libpds/libpd_so.c $(LIBPDS_FILES) $(LIBPD)
...
libpds/m_libpd_autogenerated.h: libpds/gen.scm
	which guile
	libpds/gen.scm c-file >libpds/m_libpd_autogenerated.h

libpds/m_libpd.h: libpds/gen.scm
	which guile
	libpds/gen.scm h-file >libpds/m_libpd.h
...
clean:
	rm -f ${PD_FILES:.c=.o} ${JNI_FILE:.c=.o} ${HOOK_SET:.c=.o} libpds/m_libpd_autogenerated.h libpds/m_libpd.h libpds/libpd_so.c libpds/bin2c
