...
loader-file.c: make.scm
	./make.scm gen-loader-file >loader-file.c
...
$(LIBPD): externalobjs/nbx.c.o ${PD_FILES:.c=.o}
	$(CC) -o $(LIBPD) ${PD_FILES:.c=.o} `./make.scm print-object-files` $(LDFLAGS) -lm -lpthread

externalobjs/nbx.c.o: # make.scm
	./make.scm compile
