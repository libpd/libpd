...
LIBPDS_FILES = libpd_wrapper/m_libpd.c
...
$(LIBPDS): libpd_wrapper/m_libpd_autogenerated.h libpd_wrapper/m_libpd.h libpd_wrapper/libpd_so.c $(LIBPDS_FILES) $(LIBPD)
	$(CC) $(CFLAGS) -o $(LIBPDS) $(LIBPDS_FILES) $(LDFLAGS) -lm -ldl

libpd_wrapper/libpd_so.c: libpd_wrapper/bin2c $(LIBPD)
	libpd_wrapper/bin2c libs/libpd.so >libpd_wrapper/libpd_so.c

libpd_wrapper/bin2c: libpd_wrapper/bin2c.c
	$(CC) libpd_wrapper/bin2c.c -Wall -o libpd_wrapper/bin2c

$(LIBPD): ${PD_FILES:.c=.o}
	$(CC) -o $(LIBPD) $^ $(LDFLAGS) -lm -lpthread 

libpd_wrapper/m_libpd_autogenerated.h: libpd_wrapper/gen.scm
	which guile
	libpd_wrapper/gen.scm c-file >libpd_wrapper/m_libpd_autogenerated.h

libpd_wrapper/m_libpd.h: libpd_wrapper/gen.scm
	which guile
	libpd_wrapper/gen.scm h-file >libpd_wrapper/m_libpd.h
...
clean:
	rm -f ${PD_FILES:.c=.o} ${JNI_FILE:.c=.o} ${HOOK_SET:.c=.o} libpd_wrapper/m_libpd_autogenerated.h libpd_wrapper/m_libpd.h libpd_wrapper/libpd_so.c libpd_wrapper/bin2c
