...
ifeq ($(UNAME), Darwin)  # Mac
  ...
  ifeq ($(OS), Windows_NT)  # Windows, use Mingw
    ...
    PLATFORM_CFLAGS = -DHAVE_LIBDL -Wno-int-to-pointer-cast \
      ...
      -I"$(JAVA_HOME)/include/linux" -O3 -g -D_GNU_SOURCE
...
pd_SOURCES = \
    ...
    pure-data/src/s_main.c pure-data/src/s_inter.c pure-data/src/s_file.c pure-data/src/s_print.c \
    ...
    pure-data/src/import.c pure-data/src/path.c pure-data/src/print.c pure-data/src/closebang.c pure-data/src/initbang.c pure-data/src/loadbang.c

#removed from pd_Sources:
...
libpds/libpd_so.c: libpds/bin2c $(LIBPD)
	libpds/bin2c libs/libpd.so >libpds/libpd_so.c
...
# /home/kjetil/temp/pd-extended/externals/build/lib/pd-extended/extra/vanilla/noteout.pd_linux /home/kjetil/temp/pd-extended/externals/build/lib/pd-extended/extra/vanilla/dac~.pd_linux /home/kjetil/temp/pd-extended/externals/build/lib/pd-extended/extra/vanilla/metro.pd_linux

#  -Wl,-Bstatic /home/kjetil/temp/pd-extended/externals/build/lib/pd-extended/extra/vanilla/noteout.pd_linux  -Wl,-Bstatic /home/kjetil/temp/pd-extended/externals/build/lib/pd-extended/extra/vanilla/dac~.pd_linux  -Wl,-Bstatic /home/kjetil/temp/pd-extended/externals/build/lib/pd-extended/extra/vanilla/metro.pd_linux -Wl,-Bdynamic

# /home/kjetil/temp/pd-extended/externals/vanilla/dac~.o /home/kjetil/temp/pd-extended/externals/vanilla/noteout.o /home/kjetil/temp/pd-extended/externals/vanilla/metro.o

#

libpds/libpds_autogenerated.c: libpds/gen.scm
	which guile
	libpds/gen.scm c-file >libpds/libpds_autogenerated.c
...
clean: vanilla_clean
	rm -f ${PD_FILES:.c=.o} ${JNI_FILE:.c=.o} ${HOOK_SET:.c=.o} libpds/libpds_autogenerated.c libpds/libpds.h libpds/libpd_so.c libpds/bin2c
