...
public final class PdBase {
	 ...
	 * @return error code, 0 on success
	 */
	public synchronized static int sendMessage(String recv, String msg,
			Object... args) {
		int err = processArgs(args);
	 ...
	 */
	public static int readArray(float[] destination, int destOffset,
	 ...
	 * @return            0 on success, or a negative error code on failure
	 */
	public static int writeArray(String destination, int destOffset, 
	 ...
	 * @return error code, 0 on success
	 */
	public native static int sendNoteOn(int channel, int pitch,
			int velocity);
	 ...
	 * @return error code, 0 on success
	 */
	public native static int sendControlChange(int channel,
	 ...
	 * @return error code, 0 on success
	 */
	public native static int sendProgramChange(int channel,
			int value);
	 ...
	 * @return error code, 0 on success
	 */
	public native static int sendPolyAftertouch(int channel,
			int pitch, int value);
