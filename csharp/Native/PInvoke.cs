...
namespace LibPDBinding.Native
{
	public static class PInvoke
	{
		...
		[DllImport (DllName, EntryPoint = "libpd_set_noteonhook", CallingConvention = CallingConvention)]
		internal static extern  void set_noteonhook (LibPDNoteOnHook hook) ;

		[DllImport (DllName, EntryPoint = "libpd_set_controlchangehook", CallingConvention = CallingConvention)]
		internal static extern  void set_controlchangehook (LibPDControlChangeHook hook) ;

		[DllImport (DllName, EntryPoint = "libpd_set_programchangehook", CallingConvention = CallingConvention)]
		internal static extern  void set_programchangehook (LibPDProgramChangeHook hook) ;

		[DllImport (DllName, EntryPoint = "libpd_set_pitchbendhook", CallingConvention = CallingConvention)]
		internal static extern  void set_pitchbendhook (LibPDPitchbendHook hook) ;

		[DllImport (DllName, EntryPoint = "libpd_set_aftertouchhook", CallingConvention = CallingConvention)]
		internal static extern  void set_aftertouchhook(LibPDAftertouchHook hook) ;

		[DllImport (DllName, EntryPoint = "libpd_set_polyaftertouchhook", CallingConvention = CallingConvention)]
		internal static extern  void set_polyaftertouchhook (LibPDPolyAftertouchHook hook) ;

		[DllImport (DllName, EntryPoint = "libpd_set_midibytehook", CallingConvention = CallingConvention)]
		internal static extern  void set_midibytehook (LibPDMidiByteHook hook) ;
