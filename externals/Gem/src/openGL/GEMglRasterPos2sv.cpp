...
// Constructor
//
GEMglRasterPos2sv :: GEMglRasterPos2sv	(t_floatarg arg0=0, t_floatarg arg1=0) {
vMess(arg0, arg1);
...
void GEMglRasterPos2sv :: obj_setupCallback(t_class *classPtr) {
	 class_addmethod(classPtr, reinterpret_cast<t_method>(&GEMglRasterPos2sv::vMessCallback),  	gensym("v"), A_DEFFLOAT, A_DEFFLOAT, A_NULL);
}

void GEMglRasterPos2sv :: vMessCallback (void* data, t_floatarg arg0, t_floatarg arg1) {
